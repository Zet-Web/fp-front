...
import { MapPin, Building2, Globe, GraduationCap, Loader2, ChevronsUpDown } from 'lucide-react';
...
export function UniversalReferenceSelector({
  ...
  const finalSearchPlaceholder = searchPlaceholder || DEFAULT_SEARCH_PLACEHOLDERS[type];
        ...
        <PopoverTrigger asChild>
          ...
          >
            <div className="flex items-center gap-2 truncate">
              ...
              <span className="truncate">{displayValue || finalPlaceholder}</span>
            </div>
