...
import { Award, Plus, CreditCard as Edit, Trash2, ChevronUp, ChevronDown } from "lucide-react"
              ...
              {editingAward === award.id ? (
                <div className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <Label htmlFor={`edit-award-title-${award.id}`}>Award Title</Label>
                      <Input
                        id={`edit-award-title-${award.id}`}
                    ...
                    <div>
                      <Label htmlFor={`edit-award-issuer-${award.id}`}>Issuer/Organization</Label>
                      <Input
                        id={`edit-award-issuer-${award.id}`}
                    ...
                    <div>
                      <Label htmlFor={`edit-award-date-${award.id}`}>Date</Label>
                      <Input
                        id={`edit-award-date-${award.id}`}
                  ...
                  <div>
                    <Label htmlFor={`edit-award-description-${award.id}`}>Description</Label>
                    <Textarea
                      id={`edit-award-description-${award.id}`}
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {isEditing && (
                        <div className="flex gap-1">
                          ...
                          <Button size="sm" variant="ghost" onClick={() => startEditing(award)}>
