            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                {quickActions.map((action, index) => (
                  <Card
                    key={index}
                    className="shadow-sm hover:shadow-md transition-all duration-200 hover:scale-105 cursor-pointer"
                  >
                    <CardContent className="p-4 text-center">
                      <div
                        className={`w-12 h-12 rounded-full ${action.color} flex items-center justify-center mx-auto mb-3 transition-colors`}
                      >
            ...
            <CardContent>
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                {stats.map((stat, index) => (
                  <div
                    key={index}
                    className="text-center p-4 rounded-lg bg-accent/30 hover:bg-accent/50 transition-colors"
                  >
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-start space-x-3 p-3 rounded-lg hover:bg-accent/30 transition-colors">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Follow friends and share your first post
                  </p>
                </div>
              </div>
            </CardContent>
