...
// Quiz creation form with card-based design system and comprehensive settings
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-4">
                ...
                <div className="space-y-3 p-3 rounded-lg border bg-card">
                  ...
                  {hasTimer && errors.settings?.timerMinutes && (
                    <p className="text-sm text-destructive mt-1">
                      ...
                      <div className="space-y-2">
                        {[
                          ...
                          >
                            ...
                            {field.value === option.value && <Check className="h-4 w-4 text-blue-500" />}
                          </button>
                        ))}
                      </div>
                    )}
      ...
      {fields.map((field, aIndex) => (
        <div key={field.id} className="flex items-center gap-3">
          <Checkbox
            ...
            onCheckedChange={(checked) => {
              const controller = control._fields[`questions.${qIndex}.answers.${aIndex}.correct`];
              if (controller) {
                controller._f.onChange(checked);
              }
            }}
          ...
          <Controller
            ...
            render={({ field }) => (
              <Input {...field} placeholder={`Вариант ${aIndex + 1}`} className="flex-1" />
            )}
          />
          {fields.length > 2 && (
            <Button
