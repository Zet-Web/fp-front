...
import { CreditCard, TrendingUp, Shield, Clock, Calculator, AlertCircle } from 'lucide-react';
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-3xl font-bold">Оплата юридических услуг в рассрочку</h1>
                <p className="text-muted-foreground">
                  Сервис для создания ссылок на оплату с возможностью рассрочки для клиентов
                </p>
              </div>
            </div>
          </div>
          ...
          <Alert className="bg-blue-50 dark:bg-blue-900/20 border-blue-200 dark:border-blue-800">
            ...
            <AlertDescription className="text-blue-800 dark:text-blue-200">
              <strong>Демо-режим:</strong> Все данные являются тестовыми. Реальные платежи не производятся.
            </AlertDescription>
          </Alert>
                  ...
                  <div className="lg:col-span-1">
                    <Card className="shadow-sm hover:shadow-md transition-shadow h-full">
                      <CardContent className="p-6 space-y-4">
                        <h3 className="text-lg font-semibold">Готовы к оплате?</h3>
                        <p className="text-sm text-muted-foreground">
                          Нажмите кнопку ниже для перехода к форме оплаты. В демо-режиме используются тестовые данные.
                        </p>
                        <Button
              ...
              <Card className="shadow-sm hover:shadow-md transition-shadow bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 border-blue-200 dark:border-blue-800">
                <CardContent className="p-6 space-y-3">
                  ...
                  <div className="space-y-2 text-sm text-blue-800 dark:text-blue-200">
                    <p>1. Юрист создает ссылку на оплату с указанием стоимости услуги</p>
                    <p>2. Клиент выбирает удобный план рассрочки (от 3 до 24 месяцев)</p>
                    <p>3. Клиент оплачивает первый взнос, остальное — банку в рассрочку</p>
                    <p>4. Юрист получает полную сумму на свой счет сразу</p>
                    <p>5. Клиент погашает задолженность перед банком по графику платежей</p>
                  </div>
                </CardContent>
              </Card>
            </div>
          ...
          {!paymentLink && (
            <div className="text-center py-16 space-y-4">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-2">Начните с создания ссылки</h3>
                <p className="text-muted-foreground max-w-md mx-auto">
                  Укажите стоимость юридической услуги и создайте ссылку для клиента.
                  После этого вы сможете рассчитать условия рассрочки.
                </p>
              </div>
            </div>
          )}
